...
public class InterruptExitContextLogStruct extends BaseLogStructInfo {
	...
	public InterruptExitContextLogStruct() {
		super();
		// TODO Auto-generated constructor stub
	}
	public InterruptExitContextLogStruct(ILogType type) {
		super(type);
		// TODO Auto-generated constructor stub
	}	
	...
	public void setTaskIdentity(Integer taskId) {
	...
	public String toString() {
		return super.toString() + "\t" 
				+ "log name is: " + "InterruptExitContextLogStruct" + "\t"
