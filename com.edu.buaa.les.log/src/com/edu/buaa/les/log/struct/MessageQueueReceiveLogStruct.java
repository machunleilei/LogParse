...
public class MessageQueueReceiveLogStruct extends SynchronousBaseLogStruct {
	...
	public MessageQueueReceiveLogStruct() {
		// TODO Auto-generated constructor stub
		__initData();
	}
	public MessageQueueReceiveLogStruct(ILogType type){
		super(type);
		__initData();
	}
	...
	public String toString(){
		String retString = super.toString() + "\t"
				+ "log name is: " + "MessageQueueReceive" + "\t"
